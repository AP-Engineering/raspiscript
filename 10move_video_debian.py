...
# Correction: Nzbget.conf file changed to call python3 on .py scripts, alternatively one
#             could change the extension of these python3 files to .py3

# date July 10, 2022
# extending the retention time, plan to delete the files in the downloaded folder after x days (not done yet)
# reorganized the format of the TV share folders to M_D_Y
# -----------------------------------------------------------------------
# ------- Main Program --------------------------------------------------
...
DelDownloadAfterDays = 180
#delete download folder after x days, when files most likely no longer required
DeleteAfterDays = 60
# after this many days the old files will be deleted on the external USB drive
...
today = time.strftime("%m_%d_%Y")# formating for new folder
